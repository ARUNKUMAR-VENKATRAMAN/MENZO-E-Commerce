...
>
  ...
  {/* Discount Badge */}
  {item.discount && (
    <div className="absolute top-2 left-2 sm:top-4 sm:left-4 z-10 bg-linear-to-r from-[#1D9C7A] to-[#88C7B3] text-white text-[9px] sm:text-xs font-bold px-2 py-1 sm:px-3 sm:py-1.5 rounded-full shadow-lg">
      {item.discount}% OFF
    </div>
  )}

  {/* Product Image - Responsive Height */}
  <div className="w-full h-44 xs:h-52 sm:h-60 md:h-72 lg:h-80 overflow-hidden rounded-lg sm:rounded-xl bg-linear-to-br from-[#F3F1EC] to-[#E4E3E7] shadow-inner">
    <img
      onClick={() => onView(item)}
...
const Product = ({ pageMode = false }) => {
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        {/* Filters Sidebar */}
        <aside className="hidden lg:block col-span-1 bg-linear-to-br from-white to-[#F3F1EC] p-6 rounded-2xl shadow-lg border border-[#E4E3E7] sticky top-24 h-[calc(100vh-6rem)] overflow-auto">
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              {[
                ...
                <button
                  ...
                  className={`px-3 py-1.5 text-sm rounded-lg border-2 transition-all duration-300 ${priceRange[0] === preset.range[0] && priceRange[1] === preset.range[1]
          ...
          <div className="mt-6">
            <button
              className="w-full px-4 py-3 bg-linear-to-r from-[#E4E3E7] to-[#D5D5E1] text-[#0F172A] rounded-xl font-bold hover:from-[#D5D5E1] hover:to-[#E4E3E7] transform hover:scale-105 transition-all duration-300 shadow-md hover:shadow-lg"
  ...
  <div className="flex items-center justify-between mb-4 sm:mb-6 bg-linear-to-r from-[#F3F1EC] to-[#E4E3E7] p-3 sm:p-4 rounded-lg sm:rounded-xl">
  ...
  {loading ? (
    <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-6">
      {Array.from({ length: 6 }).map((_, i) => (
        <div key={i} className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-2.5 sm:p-4 flex flex-col animate-pulse border border-[#E4E3E7]">
          <div className="h-40 sm:h-48 md:h-56 mb-3 sm:mb-4 bg-linear-to-br from-[#F3F1EC] to-[#E4E3E7] rounded-lg sm:rounded-xl" />
    ...
    <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-6">
      {displayed.map(p => (
        ...
        >
          <div className="relative aspect-square mb-2 sm:mb-3 bg-linear-to-br from-[#F3F1EC] to-[#E4E3E7] rounded-lg sm:rounded-xl overflow-hidden">
            {p.discount ? (
              <div className="absolute left-1.5 top-1.5 sm:left-2 sm:top-2 bg-linear-to-r from-[#1D9C7A] to-[#88C7B3] text-white text-[9px] sm:text-xs font-bold px-1.5 py-0.5 sm:px-2.5 sm:py-1 rounded-full shadow-lg z-10">
                {p.discount}% OFF
              </div>
            ) : null}
          ...
          <div className="mt-1.5 sm:mt-2 flex flex-col sm:flex-row items-center gap-1.5 sm:gap-2">
            ...
            <button
              ...
              className="w-full sm:flex-1 px-2 sm:px-3 py-1.5 sm:py-2 bg-linear-to-r from-[#1D9C7A] via-[#88C7B3] to-[#BEDCD0] text-white rounded-lg font-semibold text-[10px] sm:text-sm hover:from-[#88C7B3] hover:via-[#1D9C7A] hover:to-[#88C7B3] transition-all duration-300 shadow-md hover:shadow-xl transform hover:scale-105"
            >
              Add to cart
            </button>
          </div>
        ...
        <div className="fixed inset-0 z-50 bg-[#0F172A] bg-opacity-60 backdrop-blur-sm flex items-center justify-center p-4 animate-fadeIn">
          <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl max-h-[85vh] overflow-hidden border-2 border-[#1D9C7A] animate-slideUp">
            ...
            <div className="flex items-center justify-between p-6 pb-4 border-b-2 border-[#E4E3E7] bg-white sticky top-0 z-10">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-linear-to-br from-[#1D9C7A] to-[#88C7B3] rounded-xl flex items-center justify-center">
            ...
            <div className="p-6 overflow-y-auto" style={{ maxHeight: 'calc(85vh - 160px)' }}>
              ...
              <div className="mb-6">
                <h3 className="font-bold text-base text-[#0F172A] mb-3 flex items-center gap-2">
                  <span className="w-1 h-5 bg-linear-to-b from-[#1D9C7A] to-[#88C7B3] rounded-full"></span>
                  Category
                </h3>
                <div className="space-y-2">
                  {categories.map((cat, index) => (
                    <label
                      key={cat._id}
                      className="flex items-center gap-3 p-3 rounded-xl bg-linear-to-r from-[#F3F1EC] to-white border border-[#E4E3E7] cursor-pointer hover:border-[#1D9C7A] transition-all duration-200 group"
              ...
              <div className="mb-6">
                ...
                <div className="bg-linear-to-r from-[#F3F1EC] to-white p-4 rounded-xl border border-[#E4E3E7]">
              ...
              {(selectedCategories.length > 0 || priceRange[0] > 0 || priceRange[1] > 0) && (
                <div className="mb-6 p-4 bg-linear-to-r from-[#1D9C7A]/10 to-[#88C7B3]/10 rounded-xl border border-[#1D9C7A]/30">
            ...
            <div className="p-6 pt-4 border-t-2 border-[#E4E3E7] bg-white sticky bottom-0">
              <div className="flex gap-3">
                ...
                <button
                  className="flex-1 px-4 py-3 bg-linear-to-r from-[#1D9C7A] via-[#88C7B3] to-[#BEDCD0] text-white rounded-xl font-bold hover:from-[#88C7B3] hover:via-[#1D9C7A] hover:to-[#88C7B3] transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center justify-center gap-2"
                  onClick={() => setShowFiltersMobile(false)}
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
